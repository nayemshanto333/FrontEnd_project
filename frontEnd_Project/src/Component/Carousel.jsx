...
function Carousel() {
  ...
  return (
    <section className="overflow-hidden my-8">
      <h1 className="text-2xl lg:text-4xl text-center text-[#26395C] font-bold">
      ...
      <div className="relative w-full max-w-screen-2xl mx-auto ">
        <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col lg:flex-row w-full px-12 gap-6 items-center">
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-4">
              <h2 className="ms-5 sm:ms-0 font-bold text-2xl lg:text-4xl w-[60%] leading-tight text-[#26395C]">
                {currentSlider.title}
              </h2>
        ...
        <div className="flex justify-center items-center gap-2 mt-4">
          {CarouselData.map((_, index)=>(
            <button onClick={()=> handleDoClick(index)} key={index} className={`w-3 h-3 rounded-full ${
              index === currentIndex 
              ? "bg-black"
              : "bg-indigo-200"
            }`}>
